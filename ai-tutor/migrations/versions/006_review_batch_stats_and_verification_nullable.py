...
def upgrade():
    ...
    op.alter_column('verification_logs', 'chunk_id', existing_type=sa.dialects.postgresql.UUID(as_uuid=True), nullable=True)
...
def downgrade():
    ...
    op.alter_column('verification_logs', 'chunk_id', existing_type=sa.dialects.postgresql.UUID(as_uuid=True), nullable=False)