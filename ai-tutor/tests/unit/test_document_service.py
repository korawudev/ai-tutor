...
class TestProcessDocument:
    ...
    async def test_url_fetch_fails(self, db, knowledge_service_modules):
        ...
        with patch(
            "app.services.document_service.fetch_document",
...
class TestBatchImport:
    ...
    async def test_skip_duplicate(self, db, knowledge_service_modules):
        ...
        with (
            patch("app.services.document_service.ImportBatch", return_value=batch),
            patch(
                "app.services.document_service.check_duplicate",
                new_callable=AsyncMock,
